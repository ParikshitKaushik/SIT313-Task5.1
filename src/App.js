  ...
  return (
    ...
    <>
      ...
      <form className="Sub_Heading">
        ...
        <input type="radio" id="question" name="input" value="Question" onClick={handleQuestionClick} />
        <label for="question">Question</label>

        <input type="radio" id="article" name="input" value="Article" onClick={handleArticleClick} />
      ...
      {question &&
        <div>
          <div className="Question_Header">
            <p className="Header_Text">What do you want to ask or share</p>
          </div>
          <div className="Title">
